...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT_69_ansi(
        ...
        _______, KC_A,	   CKC_ALPHA_LAYER_SWITCH,	 KC_S,	  KC_T,    _______,              _______,    KC_N,	KC_E,	 KC_O,	   CKC_MAGIC,  _______,  _______,           _______,
        _______,           _______,	 KC_R,	  KC_C,    KC_D,	_______,	  _______,    _______,	 KC_H,	 KC_U,  KC_M,	_______,  _______, _______,
        _______, _______,  _______,           KC_SPC,           KC_ESC, KC_BSPC,       _______,            _______,            _______, _______, _______),
};
