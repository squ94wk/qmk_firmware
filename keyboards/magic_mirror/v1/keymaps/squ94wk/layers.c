...
smart_layer_t * smart_layers[SMART_LAYER_COUNT] = {
                ...
                [LAYER_DUMB] = &(smart_layer_t){
                        .map = {
                                ...
                                L_BOT_RING  = &(smart_key_t){ .tap.keycode = KC_LEFT_CTRL, },
                                L_BOT_MID   = &(smart_key_t){ .tap.keycode = KC_M, },
                                L_BOT_IDX   = &(smart_key_t){ .tap.keycode = KC_G, },
                ...
                [LAYER_TMUX] = &(smart_layer_t){
                        .map = {
                                ...
                                L_BOT_PINK = &(smart_key_t){ .tap.keycode = KC_W, },
